        ...
        <Card className="premium-card max-w-2xl w-full">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              {language === 'es' ? 
                `Hemos recibido su registro para ${formData.lovedOneName}. Nuestro equipo se pondrá en contacto con usted en ${formData.contactEmail} dentro de 24 horas para confirmar su horario de conexión y coordinar la configuración técnica.` :
               language === 'zh' ?
                `我们已收到您为 ${formData.lovedOneName} 的注册。我们的团队将在24小时内通过 ${formData.contactEmail} 与您联系，确认您的连接时间并协调技术设置。` :
                `We've received your registration for ${formData.lovedOneName}. Our team will contact you at ${formData.contactEmail} within 24 hours to confirm your connection time and coordinate the technical setup.`}
            </p>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent className="max-h-60">
                        {t.timeSlots.map((timeSlot, index) => (
