        ...
        <Card className="mb-12">
          ...
          <CardCon
              ...
              <div className="bg-destructive/5 border-l-4 border-destructive p-4 my-6">
                  <strong>Research Finding:</strong> A system
              ...
              Measurable Quality of Li
        <Card className="mb-12">
          <CardContent
            <CardTitle className="text-2xl text-primary flex items-center gap-3">
                Technology training and regular digital commu
              How Technology Bridges the Gap
            </CardTitle>
          </CardHeader>
                  <div className="text-sm tex
            <div className="prose prose-lg max-w-none">
                  <div className="text-3xl font-bold text-primary m
