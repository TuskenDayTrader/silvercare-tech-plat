    ...
    try {
      ...
      const response = await fetch('https://api.sendgrid.com/v3/mail/send', {
        ...
        body: JSON.stringify({
          ...
          from: { email: this.fromEmail, name: 'SilverCare Tech' },
          content: [
    ...
    const html = `
      ...
      <body>
        <div class="header">
          ...
          <p>SilverCare Tech - Connecting Generations</p>
        </div>
        ...
        <div class="content">
          ...
          <div class="footer">
            <p>This email was automatically generated by SilverCare Tech.</p>
            <p>© 2024 SilverCare Tech - Connecting Generations, One Call at a Time</p>
          </div>
        </div>
      </body>
      </html>
    ...
    const html = `
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>Thank you for choosing SilverCare Tech! Your connection request for <strong>${data.lovedOneName}</strong> has been received and will be reviewed shortly.</p>
          ...
          <p>Warm regards,<br>The SilverCare Tech Team</p>
...
Thank you for choosing SilverCare Tech! Your connection request for ${data.lovedOneName} has been received.
    ...
    const html = `
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>Best regards,<br>The SilverCare Tech Team</p>
